...
public class ZhipuConstant {
	...
	public static final String ANSWER_QUESTIONS = "我对问题：'%s'的回答是：'%s'。默认问题是正确的，不要判断问题的对错，请判断回答是否正确，并根据文档给出简要的解析，格式应当形如：'对（或错）,解析：'";
	...
	public static final String ANSWER_QUESTIONS_TEMPLATE = "从文档\n\"\"\"\n{{knowledge}}\n\"\"\"\n中找问题\n\"\"\"\n{{question}}\n\"\"\"\n的答案，如果找不到答案就用自身知识回答，如果回答不完全也需要判为错误，如果回答内容属于无语义的内容或无关内容需要判为错误，如果回答'不知道'并给出提示\n不要复述问题，直接开始回答。";
}
